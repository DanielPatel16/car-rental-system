...
<!-- SideNavBar -->
<aside class="h-screen w-64 fixed left-0 top-0 border-r border-outline-variant bg-surface-container-lowest flex flex-col p-md space-y-sm shadow-sm z-30">
<div class="px-md py-lg mb-md">
<h1 class="font-headline-md text-headline-md font-bold text-primary">DriveEase Admin</h1>
<p class="font-label-sm text-secondary">Fleet Management</p>
</div>
<nav class="flex-1 space-y-xs overflow-y-auto">
<a class="flex items-center gap-md p-md text-secondary hover:bg-surface-container-high transition-colors rounded-lg font-label-md" href="dashboard.php">
<span class="material-symbols-outlined">dashboard</span>
                    Dashboard
                </a>
<a class="flex items-center gap-md p-md text-secondary hover:bg-surface-container-high transition-colors rounded-lg font-label-md" href="cars.php">
<span class="material-symbols-outlined">directions_car</span>
                    Fleet
                </a>
<a class="flex items-center gap-md p-md text-secondary hover:bg-surface-container-high transition-colors rounded-lg font-label-md" href="bookings.php">
<span class="material-symbols-outlined">calendar_month</span>
                    Bookings
                </a>
<!-- Active Tab: Customers -->
<a class="flex items-center gap-md p-md text-primary font-bold bg-secondary-container rounded-lg font-label-md" href="#">
<span class="material-symbols-outlined">group</span>
                    Customers
                </a>

</nav>
<div class="mt-auto border-t border-outline-variant pt-md px-md">
<button class="w-full bg-primary text-on-primary py-md rounded-lg font-label-md flex items-center justify-center gap-sm active:opacity-90 transition-all duration-200">
<span class="material-symbols-outlined">add</span>
                    New Booking
                </button>
<div class="flex items-center gap-md mt-lg mb-sm">
<img class="w-10 h-10 rounded-full border border-outline-variant" data-alt="A professional portrait of a male fleet manager wearing a crisp white shirt in a modern, brightly lit office environment. The lighting is soft and flattering, emphasizing a trustworthy and corporate aesthetic. The background is a blurred high-end car showroom, maintaining the DriveEase brand identity." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDTDgfw0qL9eLUL1aVnqC2e9pzd6gLOhd22VDOZsNZvCpRd41_BwGpl4bhq5c9VyBMs56iFaEYpCHdZMbp7S5Q7CEfVAXJZYsBUyamxGdeABzXLEDYDSvgR71v3UF6BpE62hm-wlHH9EhxWYwztQJ6cVrYdssrrj6Rb5Y3_sI4lZLqPdmgX2MyCRJGoQxngehlONguYaXx4H1136XQHE0gEInazPJ1WcI-gBQEGH4DOspDN9wflTby-2wiymdc5XAVqJQlgzSq3BNc"/>
<div class="overflow-hidden">
<p class="font-label-md text-on-surface truncate">Alex Rivera</p>
<p class="font-label-sm text-secondary truncate">Manager</p>
</div>
</div>
</div>
</aside>
